...
public class RoomTemplateLibrary {
    ...
    private void createStartRoom() {
        RoomTemplate t = new RoomTemplate("start_01", "Starting Room", 20, 15, RoomType.START);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createNormalRoom1() {
        RoomTemplate t = new RoomTemplate("normal_01", "Basic Room 1", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createNormalRoom2() {
        RoomTemplate t = new RoomTemplate("normal_02", "Basic Room 2", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
    ...
    private void createNormalRoom3() {
        RoomTemplate t = new RoomTemplate("normal_03", "Four Corners", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createNormalRoom4() {
        RoomTemplate t = new RoomTemplate("normal_04", "Cross Room", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createNormalRoom5() {
        RoomTemplate t = new RoomTemplate("normal_05", "L-Shape", 20, 15, RoomType.NORMAL);
        t.setDoor(2, true);
        t.setDoor(1, true);
        t.addEnemy(8, 5, "SKELETON_MELEE");
        t.addEnemy(12, 9, "RED_SLIME");
        t.addEnemy(10, 7, "BLUE_SLIME");
        registerTemplate(t);
    }

    private void createNormalRoom6() {
        RoomTemplate t = new RoomTemplate("normal_06", "Dead End", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
    ...
    private void createNormalRoom7() {
        RoomTemplate t = new RoomTemplate("normal_07", "Vertical Hall", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
    ...
    private void createNormalRoom8() {
        RoomTemplate t = new RoomTemplate("normal_08", "Horizontal Hall", 20, 15, RoomType.NORMAL);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createPitRoom() {
        RoomTemplate t = new RoomTemplate("pit_01", "Pit Room", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
        for (int i = 3; i < 7; i++) {
            for (int j = 3; j < 7; j++) {
                t.setTile(i, j, RoomTemplate.TileType.PIT);
            }
            for (int j = 13; j < 17; j++) {
                t.setTile(i, j, RoomTemplate.TileType.PIT);
            }
    ...
    private void createRockRoom() {
        RoomTemplate t = new RoomTemplate("rock_01", "Rock Room", 20, 15, RoomType.NORMAL);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setTile(5, 7, RoomTemplate.TileType.ROCK);
        t.setTile(14, 7, RoomTemplate.TileType.ROCK);
        t.setTile(8, 5, RoomTemplate.TileType.ROCK);
        t.setTile(12, 9, RoomTemplate.TileType.ROCK);
        t.addEnemy(10, 4, "SKELETON_RANGED");
        t.addEnemy(10, 10, "SKELETON_RANGED");
        t.addEnemy(7, 8, "BLUE_SLIME");
        t.addEnemy(13, 6, "BLUE_SLIME");
        registerTemplate(t);
    }

    private void createBossRoom() {
        RoomTemplate t = new RoomTemplate("boss_01", "Boss Room", 20, 15, RoomType.BOSS);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createShopRoom() {
        RoomTemplate t = new RoomTemplate("shop_01", "Shop", 20, 15, RoomType.SHOP);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    private void createTreasureRoom() {
        RoomTemplate t = new RoomTemplate("treasure_01", "Treasure Room", 20, 15, RoomType.TREASURE);
        t.setDoor(0, true);
        t.setDoor(1, true);
        t.setDoor(2, true);
        t.setDoor(3, true);
    ...
    public RoomTemplate getRandomTemplate(RoomType type, boolean[] requiredDoors) {
        ...
        if (matching.isEmpty()) return candidates.get(0);
